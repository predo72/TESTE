...
ReportBuilder Enterprise 15.02 p/ Delphi7
Todas as modificacoes estao marcadas com a palavra Viasoft.

Modificacao feita por alguem que nao comentou
 metodo CanUseXPThemes, sempre retornar False.
}
...
function CanUseXPThemes: Boolean;
begin
  // Viasoft, "(not IsLibrary)" was added in order to avoid Access Violation
  // when closing DLLs (VsRelView)
  Result := (not IsLibrary) and (DllHandle > 0) and IsAppThemed and IsThemeActive;
end;
